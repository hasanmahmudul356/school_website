                        ...
                        @foreach($data_list as $key => $news)
                            ...
                            <tr class="gradeX">
                                ...
                                <td>
                                    ...
                                    <a href="{{url('event/edit')}}/{{$news->id}}" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                    <a onclick="return confirm('are you sure?')" href="{{url('event/delete')}}/{{$news->id}}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
