...
@section('breadcrumbs_title','Contactforms List')

@section('content')
    <div class="container">
        <h2>Contactform Update</h2>
        <div id="home" class="row">
            <div class="col-md-12 text-right">
                <a href="{{url('contactform/add')}}" class="btn btn-primary"><i class="fa fa-plus"></i>Add contactform</a>
            </div>
        </div>
                ...
                <form class="form-horizontal" method="post"  action="{{url('teacher/update')}}" enctype="multipart/form-data">
                    <div class="widget-content nopadding">
                        <div class="control-group">
                            <label for="student_name" class="control-label" title="student_name">Contactforms Say</label>
                            <div class="controls">
